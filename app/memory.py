...
class ConversationMemory:
    ...
    def __init__(self, max_messages_per_conversation: int = 50):
        ...
        self._conversations: dict[str, deque] = defaultdict(lambda: deque(maxlen=self.max_messages))
    ...
    def get_recent_messages(self, conversation_id: str, n: int = 10) -> list[ChatMessage]:
        """
